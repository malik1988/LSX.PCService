...
namespace HenkTcp
{
    public class HenkTcpServer
    {
        ...
        void HenkTcpServer_DataReceived(object sender, Message e)
        {
            this.Reply = e;
            this.DataReceived -= HenkTcpServer_DataReceived;
        }
        ...
        internal void NotifyClientConnected(TcpClient Client)
        {
        ...
        internal void NotifyDataReceived(byte[] Data, TcpClient Client)
        {
            if (null != DataReceived)
                DataReceived.Invoke(this, new Message(Data, Client, _Algorithm, _EncryptionKey));
        }
